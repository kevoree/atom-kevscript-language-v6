...
var literalNames = [ null, "'import'", "'from'", "'#'", "'return'", "'='", 
                     "':'", "','", "'.'", "'+'", "'&'", "'/'", "'['", "']'", 
                     "'{'", "'}'", "')'", "'('", "'<-'", "'->'", "'for'", 
                     "'in'", "'instance'", "'add'", "'remove'", "'start'", 
                     "'stop'", "'set'", "'detach'", "'move'", "'attach'", 
                     "'bind'", "'unbind'", "'let'", "'function'", "'native'", 
                     "'net-init'", "'net-merge'", "'net-remove'", "'meta-init'", 
                     "'meta-merge'", "'meta-remove'" ];

var symbolicNames = [ null, null, null, "SHARP", "RETURN", "ASSIGN", "COLON", 
                      ...
                      "UNBIND", "LET", "FUNCTION", "NATIVE", "NETINIT", 
                      "NETMERGE", "NETREMOVE", "METAINIT", "METAMERGE", 
                      "METAREMOVE", "SOURCE_CODE", "COMMENT", "SINGLELINE_COMMENT", 
                      "NUMERIC_VALUE", "ID", "SQ_STR", "DQ_STR", "WS" ];
...
var ruleNames =  [ "script", "statement", "instance", "add", "remove", "start", 
                   ...
                   "funcCall", "funcDecl", "importDecl", "funcBody", "returnStatement", 
...
KevScriptParser.T__0 = 1;
KevScriptParser.T__1 = 2;
KevScriptParser.SHARP = 3;
KevScriptParser.RETURN = 4;
KevScriptParser.ASSIGN = 5;
KevScriptParser.COLON = 6;
KevScriptParser.COMMA = 7;
KevScriptParser.DOT = 8;
KevScriptParser.CONCAT = 9;
KevScriptParser.AMPERSAND = 10;
KevScriptParser.SLASH = 11;
KevScriptParser.LS_BRACKET = 12;
KevScriptParser.RS_BRACKET = 13;
KevScriptParser.LC_BRACKET = 14;
KevScriptParser.RC_BRACKET = 15;
KevScriptParser.R_BRACKET = 16;
KevScriptParser.L_BRACKET = 17;
KevScriptParser.RIGHT_LIGHT_ARROW = 18;
KevScriptParser.LEFT_LIGHT_ARROW = 19;
KevScriptParser.FOR = 20;
KevScriptParser.IN = 21;
KevScriptParser.INSTANCE = 22;
KevScriptParser.ADD = 23;
KevScriptParser.REMOVE = 24;
KevScriptParser.START = 25;
KevScriptParser.STOP = 26;
KevScriptParser.SET = 27;
KevScriptParser.DETACH = 28;
KevScriptParser.MOVE = 29;
KevScriptParser.ATTACH = 30;
KevScriptParser.BIND = 31;
KevScriptParser.UNBIND = 32;
KevScriptParser.LET = 33;
KevScriptParser.FUNCTION = 34;
KevScriptParser.NATIVE = 35;
KevScriptParser.NETINIT = 36;
KevScriptParser.NETMERGE = 37;
KevScriptParser.NETREMOVE = 38;
KevScriptParser.METAINIT = 39;
KevScriptParser.METAMERGE = 40;
KevScriptParser.METAREMOVE = 41;
KevScriptParser.SOURCE_CODE = 42;
KevScriptParser.COMMENT = 43;
KevScriptParser.SINGLELINE_COMMENT = 44;
KevScriptParser.NUMERIC_VALUE = 45;
KevScriptParser.ID = 46;
KevScriptParser.SQ_STR = 47;
KevScriptParser.DQ_STR = 48;
KevScriptParser.WS = 49;
...
KevScriptParser.RULE_importDecl = 29;
KevScriptParser.RULE_funcBody = 30;
KevScriptParser.RULE_returnStatement = 31;
KevScriptParser.RULE_expression = 32;
KevScriptParser.RULE_expressionList = 33;
KevScriptParser.RULE_arrayAccess = 34;
KevScriptParser.RULE_contextIdentifier = 35;
KevScriptParser.RULE_contextRef = 36;
KevScriptParser.RULE_identifier = 37;
KevScriptParser.RULE_identifierList = 38;
KevScriptParser.RULE_instancePath = 39;
KevScriptParser.RULE_portPath = 40;
KevScriptParser.RULE_dictionaryPath = 41;
KevScriptParser.RULE_instanceList = 42;
KevScriptParser.RULE_portList = 43;
KevScriptParser.RULE_type = 44;
KevScriptParser.RULE_typeName = 45;
KevScriptParser.RULE_version = 46;
KevScriptParser.RULE_duVersions = 47;
KevScriptParser.RULE_string = 48;
KevScriptParser.RULE_basic_identifier = 49;
...
KevScriptParser.prototype.script = function() {
    ...
    try {
        ...
        while((((_la) & ~0x1f) == 0 && ((1 << _la) & ((1 << KevScriptParser.T__0) | (1 << KevScriptParser.FOR) | (1 << KevScriptParser.INSTANCE) | (1 << KevScriptParser.ADD) | (1 << KevScriptParser.REMOVE) | (1 << KevScriptParser.START) | (1 << KevScriptParser.STOP) | (1 << KevScriptParser.SET) | (1 << KevScriptParser.DETACH) | (1 << KevScriptParser.MOVE) | (1 << KevScriptParser.ATTACH) | (1 << KevScriptParser.BIND))) !== 0) || ((((_la - 32)) & ~0x1f) == 0 && ((1 << (_la - 32)) & ((1 << (KevScriptParser.UNBIND - 32)) | (1 << (KevScriptParser.LET - 32)) | (1 << (KevScriptParser.FUNCTION - 32)) | (1 << (KevScriptParser.NETINIT - 32)) | (1 << (KevScriptParser.NETMERGE - 32)) | (1 << (KevScriptParser.NETREMOVE - 32)) | (1 << (KevScriptParser.METAINIT - 32)) | (1 << (KevScriptParser.METAMERGE - 32)) | (1 << (KevScriptParser.METAREMOVE - 32)) | (1 << (KevScriptParser.ID - 32)))) !== 0)) {
            this.state = 100;
            this.statement();
            this.state = 105;
            this._errHandler.sync(this);
...
KevScriptParser.prototype.arrayDecl = function() {
    ...
    try {
        ...
        this.state = 314;
        _la = this._input.LA(1);
        if((((_la) & ~0x1f) == 0 && ((1 << _la) & ((1 << KevScriptParser.AMPERSAND) | (1 << KevScriptParser.LS_BRACKET) | (1 << KevScriptParser.LC_BRACKET))) !== 0) || ((((_la - 46)) & ~0x1f) == 0 && ((1 << (_la - 46)) & ((1 << (KevScriptParser.ID - 46)) | (1 << (KevScriptParser.SQ_STR - 46)) | (1 << (KevScriptParser.DQ_STR - 46)))) !== 0)) {
            this.state = 313;
            this.expressionList();
        }
...
function ImportDeclContext(parser, parent, invokingState) {
    ...
    this.ressource = null; // StringContext
    return this;
}
...
ImportDeclContext.prototype.ID = function() {
    return this.getToken(KevScriptParser.ID, 0);
};
...
KevScriptParser.prototype.importDecl = function() {
    ...
    this.enterRule(localctx, 58, KevScriptParser.RULE_importDecl);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 347;
        this.match(KevScriptParser.T__0);
        this.state = 350;
        _la = this._input.LA(1);
        if(_la===KevScriptParser.ID) {
            this.state = 348;
            localctx.qualifier = this.match(KevScriptParser.ID);
            this.state = 349;
            this.match(KevScriptParser.T__1);
        }

        this.state = 352;
        localctx.ressource = this.string();
    } catch (re) {
    	if(re instanceof antlr4.error.RecognitionException) {
	        localctx.exception = re;
	        this._errHandler.reportError(this, re);
...
KevScriptParser.prototype.funcBody = function() {
    ...
    this.enterRule(localctx, 60, KevScriptParser.RULE_funcBody);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 357;
...
KevScriptParser.prototype.returnStatement = function() {
    ...
    this.enterRule(localctx, 62, KevScriptParser.RULE_returnStatement);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 363;
...
KevScriptParser.prototype.expression = function(_p) {
    ...
    var _startState = 64;
    this.enterRecursionRule(localctx, 64, KevScriptParser.RULE_expression, _p);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 376;
        this._errHandler.sync(this);
...
KevScriptParser.prototype.expressionList = function() {
    ...
    this.enterRule(localctx, 66, KevScriptParser.RULE_expressionList);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 386;
...
KevScriptParser.prototype.arrayAccess = function() {
    ...
    this.enterRule(localctx, 68, KevScriptParser.RULE_arrayAccess);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 394;
        this.match(KevScriptParser.ID);
...
KevScriptParser.prototype.contextIdentifier = function(_p) {
    ...
    var _prevctx = localctx;
    var _startState = 70;
    this.enterRecursionRule(localctx, 70, KevScriptParser.RULE_contextIdentifier, _p);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 403;
        this._errHandler.sync(this);
...
KevScriptParser.prototype.contextRef = function() {
    ...
    this.enterRule(localctx, 72, KevScriptParser.RULE_contextRef);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 413;
...
KevScriptParser.prototype.identifier = function() {
    ...
    this.enterRule(localctx, 74, KevScriptParser.RULE_identifier);
    try {
        this.state = 432;
        this._errHandler.sync(this);
...
KevScriptParser.prototype.identifierList = function() {
    ...
    this.enterRule(localctx, 76, KevScriptParser.RULE_identifierList);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 434;
...
KevScriptParser.prototype.instancePath = function() {
    ...
    this.enterRule(localctx, 78, KevScriptParser.RULE_instancePath);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 442;
        this.identifier();
...
KevScriptParser.prototype.portPath = function() {
    ...
    this.enterRule(localctx, 80, KevScriptParser.RULE_portPath);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 453;
...
KevScriptParser.prototype.dictionaryPath = function() {
    ...
    this.enterRule(localctx, 82, KevScriptParser.RULE_dictionaryPath);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 457;
...
KevScriptParser.prototype.instanceList = function() {
    ...
    this.enterRule(localctx, 84, KevScriptParser.RULE_instanceList);
    var _la = 0; // Token type
    try {
        this.state = 476;
        switch(this._input.LA(1)) {
...
KevScriptParser.prototype.portList = function() {
    ...
    this.enterRule(localctx, 86, KevScriptParser.RULE_portList);
    var _la = 0; // Token type
    try {
        this.state = 490;
        switch(this._input.LA(1)) {
...
KevScriptParser.prototype.type = function() {
    ...
    this.enterRule(localctx, 88, KevScriptParser.RULE_type);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 492;
...
KevScriptParser.prototype.typeName = function() {
    ...
    this.enterRule(localctx, 90, KevScriptParser.RULE_typeName);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 502;
        this._errHandler.sync(this);
...
KevScriptParser.prototype.version = function() {
    ...
    this.enterRule(localctx, 92, KevScriptParser.RULE_version);
    try {
        this.state = 508;
        switch(this._input.LA(1)) {
...
KevScriptParser.prototype.duVersions = function() {
    ...
    this.enterRule(localctx, 94, KevScriptParser.RULE_duVersions);
    try {
        this.state = 512;
        switch(this._input.LA(1)) {
        case KevScriptParser.LC_BRACKET:
...
KevScriptParser.prototype.string = function() {
    ...
    this.enterRule(localctx, 96, KevScriptParser.RULE_string);
    try {
        this.state = 516;
        switch(this._input.LA(1)) {
...
KevScriptParser.prototype.basic_identifier = function() {
    ...
    this.enterRule(localctx, 98, KevScriptParser.RULE_basic_identifier);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 518;
        this.match(KevScriptParser.ID);
