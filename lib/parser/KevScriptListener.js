...
// Enter a parse tree produced by KevScriptParser#reattach.
KevScriptListener.prototype.enterReattach = function(ctx) {
};

// Exit a parse tree produced by KevScriptParser#reattach.
KevScriptListener.prototype.exitReattach = function(ctx) {
};
...
// Enter a parse tree produced by KevScriptParser#timeDecl.
KevScriptListener.prototype.enterTimeDecl = function(ctx) {
};

// Exit a parse tree produced by KevScriptParser#timeDecl.
KevScriptListener.prototype.exitTimeDecl = function(ctx) {
};


// Enter a parse tree produced by KevScriptParser#worldDecl.
KevScriptListener.prototype.enterWorldDecl = function(ctx) {
};

// Exit a parse tree produced by KevScriptParser#worldDecl.
KevScriptListener.prototype.exitWorldDecl = function(ctx) {
};
...
// Enter a parse tree produced by KevScriptParser#basicIdentifier.
KevScriptListener.prototype.enterBasicIdentifier = function(ctx) {
};

// Exit a parse tree produced by KevScriptParser#basicIdentifier.
KevScriptListener.prototype.exitBasicIdentifier = function(ctx) {
};
